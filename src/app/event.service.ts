...
export class EventService {
  private baseURL = `http://meetingplannerbackend-env.vxiuy6pa6v.us-east-2.elasticbeanstalk.com/api/v1/meeting`;
  //private baseURL = `http://localhost:8081/api/v1/meeting`; 
